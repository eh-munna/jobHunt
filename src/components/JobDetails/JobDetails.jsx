...
const JobDetails = () => {
  ...
  return (
    <div className="container mx-auto py-4 md:py-0 px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 my-8 md:my-16">
      ...
      <div className=" md:col-span-1 ">
        ...
        <button className=" w-full capitalize rounded-md p-2 md:p-4 text-[#ffffff] leading-4 font-bold text-lg bg-gradient-to-r from-[#7E90FE] from-0% to-[#9873FF] to-100%">
          Apply now
        </button>
      </div>
    </div>
