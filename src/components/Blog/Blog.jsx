        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 py-7 md:py-12">
          <div className="p-7 mb-4 rounded-lg bg-[#edeeff] space-y-4 md:space-y-6">
            ...
            <p className="text-[#757575]">
              ...
              components at different nesting levels. When the same prop (data)
              is passed through several components as an intermediate. When the
              state is changed by many components, in this case, it's
              complicated for each change to deliver the new data to other
              components manually. Then I use context API. It will help me to
              connect those nested components to the same global state
            </p>
          </div>
          <div className="p-7 mb-4 rounded-lg bg-[#edeeff] space-y-4 md:space-y-6">
            <h3 className="text-[#1A1919] font-semibold">
            ...
            <p className="text-[#757575]">
              ...
              allows you to reuse some piece of code in several parts of your
              app
            </p>
          </div>
          <div className="p-7 mb-4 rounded-lg bg-[#edeeff] space-y-4 md:space-y-6">
            ...
            <p className="text-[#757575]">
              ...
              returns an Object. The returned object has a property called
              current whose value is the argument passed to useRef. If you
              invoke it without an argument, the returned object's current
